module ActiveModel
  class Errors
    ...
    def full_messages
      ...
      each do |attribute, messages|
        ...
        if attribute == :base
          ...
          attr_name = take_the_last_one(attribute.to_s, '.')
          attr_name = attr_name.gsub('.', '_').humanize
    ...
    def take_the_last_one(attributes, separator = ' ')
      attributes.split(separator).last
    end
